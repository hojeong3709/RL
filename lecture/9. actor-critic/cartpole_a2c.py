...
class A2CAgent:
    ...
    def critic_optimizer(self):
        ...
        updates = optimizer.get_updates(params=self.critic.trainable_weights,
                                        loss=loss)
    ...
    def train_model(self, state, action, reward, next_state, done):
        ...
        if done:
            ...
            advantage = (reward + self.discount_factor * next_value) - value #액터에서 사용할 큐함수 값
            target = reward + self.discount_factor * next_value #크리틱에서 사용할 정답
